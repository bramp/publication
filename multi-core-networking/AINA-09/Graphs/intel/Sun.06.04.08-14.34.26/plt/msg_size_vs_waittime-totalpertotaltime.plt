...
#set output 'Sun.06.04.08-14.34.26/msg_size_vs_waittime-totalpertotaltime.png' 
set term postscript colour
set output 'Sun.06.04.08-14.34.26/msg_size_vs_waittime-totalpertotaltime.eps' 
...
set ylabel 'Wait Time / Total Time' 
set key top right
set logscale x
