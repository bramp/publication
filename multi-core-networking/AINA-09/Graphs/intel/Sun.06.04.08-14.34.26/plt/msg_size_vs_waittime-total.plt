...
#set output 'Sun.06.04.08-14.34.26/msg_size_vs_waittime-total.png' 
set term postscript colour
set output 'Sun.06.04.08-14.34.26/msg_size_vs_waittime-total.eps' 
...
set ylabel 'Total wait time total (s)' 
set key top right
set logscale x
