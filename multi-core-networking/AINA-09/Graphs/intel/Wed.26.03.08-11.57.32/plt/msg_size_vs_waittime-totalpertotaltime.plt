...
#set output 'Wed.26.03.08-11.57.32/msg_size_vs_waittime-totalpertotaltime.png' 
set term postscript colour
set output 'Wed.26.03.08-11.57.32/msg_size_vs_waittime-totalpertotaltime.eps' 
